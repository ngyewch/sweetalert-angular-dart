...
class AppComponent {
  ...
  void example3() {
    SweetAlert.swal("Good job!",
        text: "You clicked the button!", type: "success");
  }
  ...
  void example4() {
    SweetAlert.swal("Are you sure?",
        ...
        callback: (bool isConfirm) => SweetAlert.swal("Deleted!",
            text: "Your imaginary file has been deleted.", type: "success"));
  }
    ...
    SweetAlert.swal("Are you sure?",
        ...
        callback: (bool isConfirm) => isConfirm
            ...
            : SweetAlert.swal("Cancelled",
                text: "Your imaginary file is safe :)", type: "error"));
  }

  void example6() {
    SweetAlert.swal("Sweet!",
        text: "Here's a custom image.", imageUrl: "images/thumbs-up.jpg");
  }
  ...
  void example9() {
    SweetAlert.swal("An input!",
        ...
        callback: (inputValue) => (inputValue is bool)
            ? inputValue
            : ((inputValue != "")
                ? SweetAlert.swal("Nice!",
                    text: "You wrote: " + inputValue, type: "success")
  ...
  void example10() {
    SweetAlert.swal("Ajax request example",
        ...
        callback: (bool isConfirm) => new Timer(
            const Duration(milliseconds: 2000),
            () => SweetAlert.swal("Ajax request finished!")));
  }
}
